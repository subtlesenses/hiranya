...
export const seed = {
  ...
  rooms: [
    ...
    {order: 2, channelRoomId: 'R2', title: 'Mahakali, courtyard', beds: '1 full bed', sleeps: 2, bathroom: 'private', summary: 'The same layout, facing the courtyard through a carved lattice window.', photos: [p('04', 'Duplex apartment facing the courtyard')]},
    ...
    {order: 6, channelRoomId: 'R6', title: 'Vaishnavi, with bathroom', beds: '1 full bed', sleeps: 2, bathroom: 'private', summary: 'Original beams, lime-plastered walls, terracotta floor. Double bed, desk and wardrobe.', photos: [p('05', 'Third room with private bathroom')]},
    {order: 7, channelRoomId: 'R7', title: 'Kumari, shared bathroom', beds: '2 twin beds', sleeps: 2, bathroom: 'shared', summary: 'Two single beds. The bathroom is shared with one other room on the same floor.', photos: [p('06', 'Twin room with shared bathroom')]},
    {order: 8, channelRoomId: 'R8', title: 'Barahi, shared bathroom', beds: '1 single bed', sleeps: 1, bathroom: 'shared', summary: 'A single room with one single bed and a shared bathroom.', photos: []},
  ],
