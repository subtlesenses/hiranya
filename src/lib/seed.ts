...
export const seed = {
  ...
  rooms: [
    ...
    {order: 6, channelRoomId: 'R6', title: 'Double, with bathroom', beds: '1 full bed', sleeps: 2, bathroom: 'private', summary: 'Original beams, lime-plastered walls, terracotta floor. Double bed, desk and wardrobe.', photos: [p('05', 'Third room with private bathroom')]},
