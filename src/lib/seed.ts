...
export const seed = {
  ...
  rooms: [
    ...
    {order: 3, channelRoomId: 'R3', title: 'Brahmayani', beds: '2 twin beds', sleeps: 2, bathroom: 'private', summary: 'Second floor, under the painted roof beams. Two single beds and a deep-set window.', photos: [p('05', 'Twin room under whitewashed roof beams')]},
    {order: 4, channelRoomId: 'R4', title: 'Indrayani', beds: '1 full bed', sleeps: 2, bathroom: 'private', summary: 'Original beams, lime-plastered walls, terracotta floor. Double bed, desk and wardrobe.', photos: [p('17', 'Double room with private bathroom')]},
    ...
    {order: 6, channelRoomId: 'R6', title: 'Vaishnavi', beds: '1 full bed', sleeps: 1, bathroom: 'private', summary: 'Smaller room. Original beams, lime-plastered walls, terracotta floor. Double bed, desk and wardrobe.', photos: [p('14', 'Third small room with private bathroom')]},
    ...
    {order: 8, channelRoomId: 'R8', title: 'Barahi', beds: '1 single bed', sleeps: 1, bathroom: 'shared', summary: 'A single room with one single bed and a shared bathroom.', photos: [p('16', 'Single room with shared bathroom')]},
  ],
